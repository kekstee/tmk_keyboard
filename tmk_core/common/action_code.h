...
enum backlight_opt {
    ...
    BACKLIGHT_STEP     = 3,
    BACKLIGHT_LEVEL    = 4,
    BACKLIGHTB_INCREASE = 5,
    BACKLIGHTB_DECREASE = 6,
    BACKLIGHTB_TOGGLE   = 7,
    BACKLIGHTB_STEP     = 8,
    BACKLIGHTB_LEVEL    = 9,
};
...
#define ACTION_BACKLIGHTB_INCREASE()    ACTION(ACT_BACKLIGHT, BACKLIGHTB_INCREASE << 8)
#define ACTION_BACKLIGHTB_DECREASE()    ACTION(ACT_BACKLIGHT, BACKLIGHTB_DECREASE << 8)
#define ACTION_BACKLIGHTB_TOGGLE()      ACTION(ACT_BACKLIGHT, BACKLIGHTB_TOGGLE << 8)
#define ACTION_BACKLIGHTB_STEP()        ACTION(ACT_BACKLIGHT, BACKLIGHTB_STEP << 8)
#define ACTION_BACKLIGHTB_LEVEL(level)  ACTION(ACT_BACKLIGHT, BACKLIGHTB_LEVEL << 8 | level)
/* Command */
