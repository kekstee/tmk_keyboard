...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [3] = KEYMAP_60(
        TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS, \
        TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS, FN3,TRNS,TRNS, \
        TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS, FN8, FN7, FN6,     TRNS, \
        TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS, FN5, FN4,TRNS,TRNS, \
        TRNS,TRNS,TRNS,           FN2,                    TRNS,TRNS,TRNS,TRNS),
};
...
const action_t PROGMEM fn_actions[] = {
    ...
    [6] = ACTION_BACKLIGHTB_INCREASE(),
    [7] = ACTION_BACKLIGHTB_DECREASE(),
    [8] = ACTION_BACKLIGHTB_TOGGLE(),
};
